...
const string savePath = "plotOutput_all";
...
TGraphAsymmErrors* CreateRatioPlot(TH1* signal, THStack* background, const HistogramSetting& setting, double maxRatioLimit = 0.002) {
...
void Iteration_Directories_And_Histograms(const vector<pair<string, ProcessInfo>>& processes, const unordered_map<string, vector<HistogramSetting>>& histogramSettings) {
...
// // to run use: cmssw-el7  cmsenv  root -l -b -q Ploter_all.cpp
