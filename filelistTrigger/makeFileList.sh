...
#2024 v15 (for 2024 samples, other redirector is necessary to TTHH and TTZZ)
dasgoclient --query="file dataset=/TTHH-HHto4B_TuneCP5_13p6TeV_madgraph-pythia8/RunIII2024Summer24NanoAODv15-150X_mcRun3_2024_realistic_v2-v3/NANOAODSIM" | sed 's|^|root://cms-xrd-global.cern.ch//|' >> full_TTHH_24_15.txt
...
dasgoclient --query="file dataset=/TTZZ-ZZto4B_TuneCP5_13p6TeV_madgraph-pythia8/RunIII2024Summer24NanoAODv15-150X_mcRun3_2024_realistic_v2-v3/NANOAODSIM" | sed 's|^|root://cms-xrd-global.cern.ch//|' >> full_TTZZ_24_15.txt
...
#2024 v14 (for 2024 samples, other redirector is necessary to TTHH and TTZZ)
...
dasgoclient --query="file dataset=/TTHH-HHto4B_TuneCP5_13p6TeV_madgraph-pythia8/RunIII2024Summer24NanoAOD-140X_mcRun3_2024_realistic_v26-v3/NANOAODSIM" | sed 's|^|root://cms-xrd-global.cern.ch//|' >> full_TTHH_24_14.txt
...
dasgoclient --query="file dataset=/TTZZ-ZZto4B_TuneCP5_13p6TeV_madgraph-pythia8/RunIII2024Summer24NanoAOD-140X_mcRun3_2024_realistic_v26-v3/NANOAODSIM" | sed 's|^|root://cms-xrd-global.cern.ch//|' >> full_TTZZ_24_14.txt
