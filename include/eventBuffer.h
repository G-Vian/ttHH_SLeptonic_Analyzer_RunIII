...
struct eventBuffer
{
  ...
  bool	HLT_HT300PT30_QuadJet_75_60_45_40_TripeCSV_p07; // NanoAODv9 2017 Trigger
  bool	HLT_PFHT300PT30_QuadPFJet_75_60_45_40_TriplePFBTagCSV_3p0; // NanoAODv9 2017 Trigger
  bool	HLT_PFHT350;
  bool	HLT_PFHT350MinPFJet15;
  bool	HLT_PFHT370;
  bool	HLT_PFHT400_SixPFJet32;
  bool	HLT_PFHT400_SixPFJet32_DoublePFBTagDeepCSV_2p94;
  bool	HLT_PFHT380_SixJet32_DoubleBTagCSV_p075; // NanoAODv9 2017 Trigger
  bool	HLT_PFHT380_SixPFJet32_DoublePFBTagCSV_2p2; // NanoAODv9 2017 Trigger
  bool	HLT_PFHT430;
  bool	HLT_PFHT450_SixPFJet36;
  bool	HLT_PFHT450_SixPFJet36_PFBTagDeepCSV_1p59;
  bool	HLT_PFHT430_SixJet40_BTagCSV_p080; // NanoAODv9 2017 Trigger
  bool	HLT_PFHT430_SixPFJet40_PFBTagCSV_1p5; // NanoAODv9 2017 Trigger
  ...
  void fillJets()
  {
	...
	Jet[i].btagPNetB	= Jet_btagPNetB[i];
      	Jet[i].btagUParTAK4B	= Jet_btagUParTAK4B[i];
    ...
    choose(std::map<std::string, bool>())
  {
    ...
    choose["HLT_HT300PT30_QuadJet_75_60_45_40_TripeCSV_p07"]	        = DEFAULT; // NanoAODv9 2017 Trigger
    choose["HLT_PFHT300PT30_QuadPFJet_75_60_45_40_TriplePFBTagCSV_3p0"]	= DEFAULT; // NanoAODv9 2017 Trigger
    ...
    choose["HLT_PFHT380_SixJet32_DoubleBTagCSV_p075"]	= DEFAULT; // NanoAODv9 2017 Trigger
    choose["HLT_PFHT380_SixPFJet32_DoublePFBTagCSV_2p2"]	= DEFAULT; // NanoAODv9 2017 Trigger
    choose["HLT_PFHT430"]	= DEFAULT;
    choose["HLT_PFHT450_SixPFJet36"]	= DEFAULT;
    choose["HLT_PFHT450_SixPFJet36_PFBTagDeepCSV_1p59"]	= DEFAULT;
    choose["HLT_PFHT430_SixJet40_BTagCSV_p080"]	        = DEFAULT; // NanoAODv9 2017 Trigger
    choose["HLT_PFHT430_SixPFJet40_PFBTagCSV_1p5"]	= DEFAULT; // NanoAODv9 2017 Trigger
    ...
    choose["Jet_btagUParTAK4B"]	= DEFAULT;  
    ...
    if ( choose["HLT_IsoMu24"] )
      input->select("Events/HLT_IsoMu24", 	
		    HLT_IsoMu24);
    if ( choose["HLT_IsoTkMu24"] )
      input->select("Events/HLT_IsoTkMu24", 	
		    HLT_IsoTkMu24);
    ...
    if ( choose["HLT_HT300PT30_QuadJet_75_60_45_40_TripeCSV_p07"] )  // NanoAODv9 2017 Trigger
      input->select("Events/HLT_HT300PT30_QuadJet_75_60_45_40_TripeCSV_p07",
                     HLT_HT300PT30_QuadJet_75_60_45_40_TripeCSV_p07);
    if ( choose["HLT_PFHT300PT30_QuadPFJet_75_60_45_40_TriplePFBTagCSV_3p0"] )  // NanoAODv9 2017 Trigger
    ...
    if ( choose["HLT_PFHT380_SixJet32_DoubleBTagCSV_p075"] )
      input->select("Events/HLT_PFHT380_SixJet32_DoubleBTagCSV_p075",
    ...
    if ( choose["HLT_PFHT430_SixJet40_BTagCSV_p080"] ) // NanoAODv9 2017 Trigger
      input->select("Events/HLT_PFHT430_SixJet40_BTagCSV_p080",
                     HLT_PFHT430_SixJet40_BTagCSV_p080);
    if ( choose["HLT_PFHT430_SixPFJet40_PFBTagCSV_1p5"] ) // NanoAODv9 2017 Trigger
    ...
    if ( choose["Jet_btagUParTAK4B"] )
      input->select("Events/Jet_btagUParTAK4B", 	Jet_btagUParTAK4B);
    ...
    output(&stream)
  {
    ...
    output->add("Events/HLT_PFHT450_SixPFJet36_PFBTagDeepCSV_1p59",
                 HLT_PFHT450_SixPFJet36_PFBTagDeepCSV_1p59);
    output->add("Events/HLT_PFHT430_SixJet40_BTagCSV_p080",  // NanoAODv9 2017 Trigger
                 HLT_PFHT430_SixJet40_BTagCSV_p080);
    output->add("Events/HLT_PFHT430_SixPFJet40_PFBTagCSV_1p5",  // NanoAODv9 2017 Trigger
                 HLT_PFHT430_SixPFJet40_PFBTagCSV_1p5);
    output->add("Events/HLT_PFHT380_SixJet32_DoubleBTagCSV_p075",  // NanoAODv9 2017 Trigger
                 HLT_PFHT380_SixJet32_DoubleBTagCSV_p075);
    output->add("Events/HLT_PFHT380_SixPFJet32_DoublePFBTagCSV_2p2",  // NanoAODv9 2017 Trigger
                 HLT_PFHT380_SixPFJet32_DoublePFBTagCSV_2p2);
    output->add("Events/HLT_HT300PT30_QuadJet_75_60_45_40_TripeCSV_p07",  // NanoAODv9 2017 Trigger
                 HLT_HT300PT30_QuadJet_75_60_45_40_TripeCSV_p07);
    output->add("Events/HLT_PFHT300PT30_QuadPFJet_75_60_45_40_TriplePFBTagCSV_3p0",  // NanoAODv9 2017 Trigger
                 HLT_PFHT300PT30_QuadPFJet_75_60_45_40_TriplePFBTagCSV_3p0);
  ...
  void initBuffers()
  {
    ...
    Jet_btagUParTAK4B	= std::vector<float>(45,0);
